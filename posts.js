...
const POSTS = [
  {
    ...
    excerpt: "I opened the Sefer Asaph ha-Rofe expecting plant prescriptions. The prologue gave me a family tree instead: Noah wrote a Book of Remedies when an angel taught him herbs after the flood, Shem kept it, India's sages copied it into Sanskrit when speech split at Babel, and eighteen Hebrew manuscripts from the third to seventh centuries AD still claim that chain.",
    content: `
<p class="opening">
