...
const POSTS = [
  {
    ...
    excerpt: "Many people discover turmeric, Triphala, and warm oil through Ayurveda and credit ancient Hinduism for inventing natural healing. The herbs work. The Hebrew medical manuscripts say something harder: India's sages copied the same post-flood book Noah wrote when an angel taught him herbs, long before the Charaka or Sushruta Samhitas were compiled.",
    content: `
<p class="opening">
  I opened the <strong>Sefer Asaph ha-Rofe</strong> looking for plant prescriptions. Eighteen manuscripts survive in European libraries, compiled somewhere between the third and seventh centuries AD, and scholars treat it as the oldest Hebrew medical text we have. I expected an encyclopedia of remedies. The prologue gave me a family tree. The writers name transmitters in order, past Shem, all the way to Noah, and they insist they are not inventing medicine. They are copying a book that already existed.
</p>

<p>That book has a name in the tradition: the <strong>Sefer Refuot</strong>, the Book of Remedies. <a href="http://www.earlyjewishwritings.com/jubilees.html" target="_blank" rel="noopener">Jubilees 10:12–14</a> says Noah wrote it when heaven explained which herbs could heal the diseases striking his household after the flood, and gave the scroll to Shem. The Asaph prologue picks up the same thread centuries later: medicine stayed whole while humanity spoke one language, then fractured at Babel when seventy nations carried fragments away. India's sages, it says plainly, copied what they could into Sanskrit. Shem's line kept the inheritance in Hebrew.</p>
