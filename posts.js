...
<p>The Sefer Asaph itself is the most thoroughly studied witness to this tradition in Hebrew. Scholars date its compilation to somewhere between the third and seventh centuries. Eighteen known manuscripts survive, scattered across European libraries, the longest reaching roughly 250 folios. The most complete copy is <a href="https://digital.bodleian.ox.ac.uk/objects/7b1e0897-116f-4985-8a7d-b23518114c04/" target="_blank" rel="noopener">Oxford, Bodleian MS Opp. 687</a> (Neubauer 2138), digitized and readable online. The oldest surviving fragment appears to be <a href="https://www.genizah.org/" target="_blank" rel="noopener">JTS 10160</a> from the Cairo Genizah, two folios dated to the tenth to twelfth centuries AD. Elinor Lieber's paper in <em>Dumbarton Oaks Papers</em> 38 (1984) examined the work as a Hebrew medical encyclopedia possibly compiled on an Indian organisational model, which is a surprising conclusion for a Hebrew text unless the two traditions share deeper roots than the standard history allows. A more recent study in <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC6035742/" target="_blank" rel="noopener">Aleph: Historical Studies in Science and Judaism</a> traces Persian and Indian material woven through its pages. The more carefully scholars read it, the more they find evidence of exactly the kind of cross-tradition inheritance the prologue claims.</p>
